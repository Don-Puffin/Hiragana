export const hiraganaDummyData = [
            ...
            { japanese: "が", english: "ga" }, 
            { japanese: "ぎ", english: "gi" },
            { japanese: "ぐ", english: "gu" },
            { japanese: "げ", english: "ge" },
            ...
            { japanese: "ば", english: "ba" }, 
            { japanese: "び", english: "bi" },
            { japanese: "ぶ", english: "bu" },
            { japanese: "べ", english: "be" },
            { japanese: "ぼ", english: "bo" },
        
            { japanese: "ぱ", english: "pa" }, 
            { japanese: "ぴ", english: "pi" },
            { japanese: "ぷ", english: "pu" },
            { japanese: "ぺ", english: "pe" },
            { japanese: "ぽ", english: "po" },
