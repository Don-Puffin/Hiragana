...
const onlyEnglish = hiraganaDummyData.map((character) => character.english); //creates an array of only the english characters from the main array
...
const hiraganaGame  : NextPage = () => {
  ...
  const handleButtonClick = (characterClicked: string) => {
    ...
    const indexOfAnswer = hiraganaDummyData.findIndex((character) => character.english === questionCharacter) //finds the index of the character in the main array
    const indexOfGuess = hiraganaDummyData.findIndex((character) => character.hiragana === characterClicked) //finds the index of the character in the main array
